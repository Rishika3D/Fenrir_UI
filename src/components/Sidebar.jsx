...
const Sidebar = ({
  ...
  return (
    <div className={`w-[220px] h-full flex flex-col border-r shrink-0 ${bg}`}>
      {/* Logo */}
      <div className="px-6 py-[22px] flex items-center gap-2.5">
      ...
      <div className={`border-t ${divider} px-3 py-3 mx-2 mb-2`}>
        ...
        {navigate && (
          <button
            ...
            className={`flex items-center gap-3 px-4 py-2.5 w-full rounded-full transition-colors cursor-pointer mt-0.5 ${
              darkMode ? 'text-gray-400 hover:bg-white/5 hover:text-white' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'
            } font-medium text-sm`}
          >
